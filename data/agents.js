export default [
  {
    ...
    mockEvaluation: {
      ...
      summary:
        "Simulated evaluation complete. This session showed strong structure and solid academic clarity, with room to strengthen evidence-led follow-ups.",
      strengths: ["Clear structure", "Good composure", "Strong conceptual framing"],
      improvements: [
        "Support claims with more specifics",
  ...
  },
  {
    ...
    mockEvaluation: {
      ...
      summary:
        "Simulated evaluation complete. This session showed polished communication and strong role-fit framing, with a few places to tighten specificity.",
  ...
  },
  {
    ...
    contextFieldDescription:
      "Add fund thesis notes, investor concerns, target stage, market assumptions, or traction details you want the investor to pressure-test.",
    ...
    mockEvaluation: {
      ...
      summary:
        "Simulated evaluation complete. This session showed conviction and decent market framing, with room to sharpen evidence and differentiation.",
      strengths: ["Strong conviction", "Clear market framing", "Confident delivery"],
      improvements: [
        "Use more traction evidence",
        "Answer risk questions more directly",
        "Tighten differentiation language",
      ],
    },
  },
  {
    ...
    duration: "12 min room",
    description:
      "Practice a simple live coding round where you explain your thinking aloud while sketching the solution in code or pseudocode.",
    longDescription:
    ...
    scenario:
      "A live coding interview where the interviewer introduces the problem verbally and the candidate solves it while thinking aloud.",
    ...
    contextFieldDescription:
      "Add role stack, interview focus areas, company expectations, or topics you want the technical interviewer to emphasize while asking the problem.",
    evaluationCriteria: [
      {
        label: "Problem understanding",
        description:
          "How well the speaker identifies the task, clarifies assumptions, and frames the solution before coding.",
      },
      {
        label: "Algorithmic reasoning",
        description:
          "How clearly the speaker explains the chosen approach, tradeoffs, and complexity while solving the problem.",
      },
      {
        label: "Code clarity",
        description:
          "How readable, organized, and interview-ready the written solution or pseudocode is.",
      },
      {
        label: "Communication while coding",
        description:
          "How well the speaker maintains a useful think-aloud narrative while typing and responding to follow-up questions.",
      },
    ],
    ...
    codingQuestionBank: [
      {
        ...
        difficulty: "Easy",
        prompt:
          "Given an array of integers and a target value, return the indices of the two numbers that add up to the target. Assume there is exactly one valid answer and the same element cannot be used twice.",
      },
      {
    ...
    mockEvaluation: {
      ...
      summary:
        "Simulated evaluation complete. This session showed a good think-aloud process and a workable solution, with room to make the final code more polished and explicit about complexity.",
      strengths: [
        "Clear approach explanation",
        "Good handling of edge cases",
        "Steady communication while typing",
      ],
      improvements: [
        "State complexity earlier",
        "Make variable naming clearer",
        "Narrate code changes more explicitly",
      ],
    },
  },
  {
    ...
    longDescription:
      "A flexible room for when you need the UI and workflow of SimCoach without being boxed into one archetype. It works well for product demos, leadership updates, class presentations, and hybrid prep sessions.",
    scenario:
    ...
    mockEvaluation: {
      ...
      summary:
        "Simulated evaluation complete. This session showed balanced delivery and good composure, with a few opportunities to add stronger specifics.",
      strengths: ["Adaptable delivery", "Calm presence", "Consistent pacing"],
      improvements: [
        "Add more supporting detail",
        "Make answers more concise",
        "Increase conviction in key moments",
      ],
    },
  },
  {
