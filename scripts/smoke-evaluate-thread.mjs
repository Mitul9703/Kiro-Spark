  ...
  return {
    ...
    evaluation: {
      ...
      metrics: [
        ...
        { label: 'Impact storytelling', value: Math.max(0, score - 5), justification: 'Worked example.' },
        { label: 'Ownership signals', value: Math.max(0, score - 10), justification: 'Worked example.' },
...
const body = {
  ...
  sessions: [
    fixtureSession({ id: 'sess-A', score: 62, summary: 'Older baseline run.', endedAtOffsetMs: 5 * 24 * 3600 * 1000 }),
    fixtureSession({ id: 'sess-B', score: 78, summary: 'More recent run, tighter.', endedAtOffsetMs: 1 * 24 * 3600 * 1000 }),
  ],
};
...
console.log('OK trajectory=%s metricTrends=%d hiddenGuidance.length=%d',
