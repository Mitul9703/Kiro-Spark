...
const body = {
  ...
  briefs: [
    ...
    },
    {
      ...
      searchPhrases: [
        "interview answers about leadership without authority",
        "showing ownership in behavioral interview",
      ],
...
if (!Array.isArray(json.topics)) {
  console.error("topics missing", json);
  process.exit(1);
}
if (json.topics.length !== 2) {
  console.error("expected topics.length === 2, got", json.topics.length);
  process.exit(1);
}
